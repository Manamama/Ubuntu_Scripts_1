...
run_cmd="whisperx --compute_type float32 --model medium \"\$HOME/Downloads/$base_filename\" --output_dir \$HOME/Downloads/ --print_progress True --verbose False $extra_args"
